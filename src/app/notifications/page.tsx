...
export default function NotificationsPage() {
  ...
  const { notifications: initialNotifications, markAsRead } =
    useNotifications();
            ...
            >
              <div className="flex items-start gap-4">
                ...
                {notification.data?.iconUrl ? (
                  <img
                    src={
                      getUploadUrl(notification.data.iconUrl) ||
                      notification.data.iconUrl
                    }
                    alt="Kategoriya"
                  ...
                  <img
                    src={
                      getUploadUrl(notification.data.adminAvatar) ||
                      notification.data.adminAvatar
                    }
                  ...
                  notification.data?.adminUsername ? (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {notification.data?.imageUrl && (
                    <div className="mt-3">
                      <img
                        src={
                          getUploadUrl(notification.data.imageUrl) ||
                          notification.data.imageUrl
                        }
                        alt="Xabar rasmi"
                    ...
                    <div className="mt-3">
                      {(() => {
                        const videoUrl: string =
                          getUploadUrl(notification.data?.videoUrl) ||
                          notification.data?.videoUrl ||
                          "";
                        return (
                          <video
