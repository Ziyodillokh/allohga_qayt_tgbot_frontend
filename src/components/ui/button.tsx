...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      default:
        "bg-teal-600 text-white hover:bg-teal-700 focus:ring-teal-500 shadow-lg shadow-teal-500/25",
      secondary:
      ...
      danger:
        "bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 shadow-lg shadow-red-500/25",
      link: "text-teal-600 underline-offset-4 hover:underline focus:ring-teal-500 dark:text-teal-400",
    };
